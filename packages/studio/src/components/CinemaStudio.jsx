          ...
          {filtered.map((m) => (
            ...
            >
              <div className="flex items-center gap-3.5 min-w-0">
                <div className="w-8 h-8 shrink-0 bg-primary/10 text-primary border border-white/5 rounded-lg flex items-center justify-center font-black text-xs shadow-inner uppercase overflow-hidden">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {isReplicate && (
                  <div className="relative">
                    ...
                    >
                      <span className="w-5 h-5 shrink-0 rounded-md bg-white/[0.04] text-white/70 border border-white/[0.06] flex items-center justify-center overflow-hidden shadow-inner">
                        <ModelProviderMark
                          model={selectedModel}
                          glyphClassName="w-3.5 h-3.5"
                        />
                      </span>
                      <span className="text-xs font-semibold text-white/70 group-hover:text-[var(--primary-color)] transition-colors truncate">
